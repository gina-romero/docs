...
description: Get started with Analytics. Connect your first data source, build a dashboard, and share insights with your team in under 15 minutes.
---
...
- Explore the available chart types to find the best visualization for your data.
